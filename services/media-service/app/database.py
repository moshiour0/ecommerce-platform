...
# media_meta_db is the database init-dbs.sh actually creates. The compose file
# pointed at media_db for a long time, which was harmless only because this
# service never opened a connection.
DATABASE_URL = os.getenv(
    "DATABASE_URL",
    "postgresql+asyncpg://admin:supersecret@postgres:5432/media_meta_db",
)
